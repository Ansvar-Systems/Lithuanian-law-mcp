...
## [1.0.0] - 2026-02-21
### Added
- Initial release of Lithuanian Law MCP
- `search_legislation` tool for full-text search across Lithuanian legislation
...
- `get_lithuanian_implementations` tool for finding national EU implementations
...
[1.0.0]: https://github.com/Ansvar-Systems/Lithuanian-law-mcp/releases/tag/v1.0.0
